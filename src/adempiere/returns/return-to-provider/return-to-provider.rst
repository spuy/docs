...
Seleccione el icono "**Registro Nuevo**" en la barra de herramientas de Solop ERP y proceda al llenado de los campos correspondientes.
    ...
    Seleccione el tipo de documento a generar en el campo "**Tipo de Documento Destino**", la selección de este define el comportamiento del documento que se esta elaborando, dicho comportamiento se encuentra explicado en el documento **Tipo de Documento**. Para este ejemplo el tipo de documento es "**Autorización Devolución Proveedor Nacional**".
...
Seleccione el icono "**Registro Nuevo**" en la barra de herramientas de Solop ERP y proceda al llenado de los campos correspondientes.
    ...
    Seleccione el tipo de documento a generar en el campo "**Tipo de Documento Destino**", la selección de este define el comportamiento del documento que se esta elaborando, dicho comportamiento se encuentra explicado en el documento **Tipo de Documento**. Para este ejemplo el tipo de documento es "**Devolución a Proveedor Nacional**".
