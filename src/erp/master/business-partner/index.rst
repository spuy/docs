...
.. _src/erp/master/business-partner:
...
Esta documentación pretende ofrecerle una guía fácil para la definición básica de un socio de negocio en Solop ERP, dentro de este orden de ideas, es importante seguir paso a paso cada procedimiento, de ello dependerá el éxito de los registros resultantes.
...
.. toctree::
    ...
    business-partner
    business-partner-migration/index
    customer/index
    employee/index
    vendor/index